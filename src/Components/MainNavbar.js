...
export default function Main() {
    ...
    return (
        ...
        <div className={classes.root}>
            ...
            <Drawer //вся выдвигающаяся панелька
                variant="permanent"
            ...
            >
                ...
                <Divider />
                <List>
                    <ListItem button key="Статистика" component={RouterLink} to='/clicks'>
                        <ListItemIcon ><TableChartSharp/></ListItemIcon>
                        <ListItemText primary="Статистика" />
                    </ListItem>
                    <ListItem button key="Графики" component={RouterLink} to='/chart'>
